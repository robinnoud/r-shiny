...
filtered_data3 <- data_list[data_list$overflow == TRUE, ]
data_page3 <- data.frame(
  Category = c("overflowStands.capacity",
               "overflowStands.availabilities.bikes",
  ...
  Value = c(sum(filtered_data3$overflowStands.capacity),
            sum(filtered_data3$overflowStands.availabilities.bikes),
            sum(filtered_data3$overflowStands.availabilities.stands),
            sum(filtered_data3$overflowStands.availabilities.mechanicalBikes),
            sum(filtered_data3$overflowStands.availabilities.electricalBikes),
            sum(filtered_data3$overflowStands.availabilities.electricalInternalBatteryBikes),
            sum(filtered_data3$overflowStands.availabilities.electricalRemovableBatteryBikes))
)
